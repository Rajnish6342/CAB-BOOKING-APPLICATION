...
include_once("conn.php");
  ...
  $imageFileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
     ...
     // "the file",basename($_FILES ["img"] ["name"]),"has been uploaded.";
         ...
         $query= "insert into drivers (d_fname,d_sname,d_s1,d_s2,d_city,d_state,d_zip,d_mail,d_mno,d_gen,d_limg) values ('$fname','$sname','$ad1','$ad2','$city','$cnt','$zip','$email','$mno','$gen','$img')";
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="txtFName" name="fname">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtLName" name="sname">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtsa1" name="ad1">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtsa2" name="ad2">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtCountry" name="cnt">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="textZip" name="zip">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="text5" name="mno">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" placeholder="Upload Profile Photo"
