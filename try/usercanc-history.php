	...
	<body>
		...
		<div class="tj-wrapper">
            ...
            <li><a href="logout.php">Sign Out</a></li>
                    ...
                    $sql = "SELECT vehicle.v_img as Vimage1,vehicle.v_canc,bookings.canc_date,bookings.start_loc,bookings.end_loc,bookings.book_ref,bookings.pickup_time,bookings.bk_date,bookings.fare,bookings.dist,bookings.drvr,bookings.bk_status from bookings join vehicle on bookings.v_id=vehicle.v_id  where bookings.email_id='$email'   &&  bookings.bk_status='2' or bookings.bk_status='4' LIMIT $start_from, $limit";
				   ...
				   ?>
											...
											<li >
												...
												<p><b>Booking on:</b><?php echo $row['bk_date'] ?><p>
												<p><b>Cancelled on:</b><?php echo $row['canc_date'] ?><p>
												<?php
                                            if ($row['bk_status'] == 2) {
                                            ...
                                            ?>
												...
												<p><b>Cancelled Price:</b><?php echo $status ?> ₹<p>
												</div>
												
												
												<div class="vehicle_status"> <a href="#" class="btn outline btn-xs "><b>Cancelled</b></a>
					...
					<?php } ?>
										...
										<ul>
										<?php	$sql = "select count(*) from bookings where  email_id='$email' &&  bk_status='2' or bk_status='4' ";   
...
for ($i=1; $i<=$total_pages; $i++) { 
  if($i==$pn)  
    $pagLink .= "<li class='current'><a  href='usercanc-history.php?page= 
                                    ".$i."'>".$i."</a></li>"; 
  else
    $pagLink .= "<li><a href='usercanc-history.php?page=".$i."'> 
                                        ".$i."</a></li>";   
};   
echo $pagLink; 
?>
