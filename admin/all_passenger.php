...
{  ?>
												...
												<tr class="odd gradeX">
													...
													<td class="center"><a href="mailto:<?php echo $row['2']; ?>">
													<?php echo $row['2']; ?></a></td>
													<td class="center"><a href="tel:<?php echo $row['3']; ?>">
													<?php echo $row['3']; ?> </a></td>
													<?php if($row['5']==0)
									{
										$staus="Active";
									 ...
									 else
									 {
										...
										$clrs="label-danger";
													...
													<td>
														<span class="label label-sm box-shadow-1 <?php echo $clrs ?>"><?php echo $staus ?></span>
													</td>
													<form method="post">
													<td class="center">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a href="pstatus.php?s=0&id=<?php echo $row['0']?>">
                                                                    <i class="icon-docs"></i> Active </a>
                                                            </li>
                                                            <li>
                                                                <a href="pstatus.php?s=1&id=<?php echo $row['0']?>">
