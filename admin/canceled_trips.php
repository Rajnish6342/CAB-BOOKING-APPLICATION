								...
								<div class="card-body ">
									<div class="table-scrollable">
										<table id="tableExport">
											...
											<?php
include("conn.php");
$sql="SELECT vehicle.v_canc as canc,bookings.start_loc,bookings.username,bookings.end_loc,bookings.book_ref,bookings.pickup_time,bookings.pickup_date,bookings.dist,bookings.fare,bookings.canc_date  from bookings join vehicle on bookings.v_id=vehicle.v_id  where bookings.bk_status='2'";
...
foreach($result as $row)
{
  ?>
												...
												<tr>
													...
													<td><?php echo $row['canc_date']; ?></td>
													
													<td><?php echo $row['canc']; ?>₹</td>
