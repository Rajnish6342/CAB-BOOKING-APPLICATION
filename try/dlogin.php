						...
						<div class="col-md-12 col-sm-12">
							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="login">
									...
									<div class="col-md-6 col-sm-6">
										<form class="login-frm" method="POST" action="ajax/dlogin.php" onsubmit="return do_dlogin();" >
											...
											<a href="forgot.php" class="forget-pass">Forget Password?</a>
...
function do_dlogin()
{
 ...
 if(email!="" && pass!=""){
  ...
  if(result=="success")
  {
    window.location.href="driver-account.php";
  }
  else
  {
    Swal.fire(
