		...
		<div class="tj-wrapper">
            ...
            <li><a href="logout.php">Sign Out</a></li>
					...
					<?php } ?>
										...
										<ul>
										<?php	$sql = "select count(*) from bookings where bk_status='1' && email_id='$email' ";   
...
for ($i=1; $i<=$total_pages; $i++) { 
  if($i==$pn)  
    $pagLink .= "<li class='current'><a  href='usercomp-history.php?page= 
                                    ".$i."'>".$i."</a></li>"; 
  else
    $pagLink .= "<li><a href='usercomp-history.php?page=".$i."'> 
                                        ".$i."</a></li>";   
};   
echo $pagLink; 
?>
