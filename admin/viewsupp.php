...
$queryID = $_REQUEST['id'];
$sql = "UPDATE cont_us SET cont_status =1 where cont_id=$queryID";
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="profile-view">
                                <?php
                                $sql = "SELECT * FROM cont_us where cont_id=$queryID";
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <span class="text"><?php echo $row['cont_name']; ?></span>
                                            </li>
                                            <li>
                                                <span class="title">Email:</span>
                                                <span class="text"><a href="#"><?php echo $row['cont_email']; ?></a></span>
                                            </li>
                                            <li>
                                                <span class="title">Subject:</span>
                                                <span class="text"><a href="#"><?php echo $row['cont_sub']; ?></a></span>
                                            </li>
