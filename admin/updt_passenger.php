				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Update Passeger</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Update Passenger</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Update Passenger</header>
								...
								<form method="post" action="updtps.php"  enctype="multipart/form-data" autocomplete="off">
								...
								<div class="<?php echo @$msg1;?> " ><?php echo @$msg;?> </div>  
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="txtFName" name="name" required value="<?php echo $row['uname'] ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="email" id="txtemail" name="email" value="<?php echo $row['uemail'] ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="text5" name="mno"value="<?php echo $row['uno'] ?>" required>
