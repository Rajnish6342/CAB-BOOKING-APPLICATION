	    	...
	    	<div class="tj-breadcrumb">
				<div class="container">
					<ul class="breadcrumb-list">
						...
						<li class="active">Driver Account</li>
					</ul>
				</div>
	    	</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="tj-tabs">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li ><a href="dbooking-history.php" ><i class="far fa-user"></i> Bookings</a></li>
									<li><a href="dlogout.php" ><i class="fas fa-sign-out-alt"></i> Logout</a></li>
								</ul>
							</div>
							<div class="tab-content">
								<div class="tab-pane active" id="confirm_booking">
									<form class="account-frm" method="POST"action="ajax/driver.php" onsubmit="return do_account();" >
									<?php
										
										include("conn.php");
										
										$email=$_SESSION['dlogin'];
										$query= "select * from drivers where d_mail='$email'";
										...
										<div class="col-md-6 col-sm-6">
											<div class="account-field">
												...
												<input type="text" id="name" placeholder="Enter  Name" disabled value="<?php echo $row['d_fname'] ?> <?php echo $row['d_sname'] ?>">
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6">
											<div class="account-field">
												...
												<input type="tel" id="mobile" placeholder="Enter Phone Number" value="<?php echo $row['d_mno'] ?>" > 
											</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<div class="account-field">
												...
												<input type="email" id="email" placeholder="Enter Email id" disabled value="<?php echo $row['d_mail'] ?>">
											</div>
										</div>
