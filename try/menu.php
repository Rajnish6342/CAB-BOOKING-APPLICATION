    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                <!--Logo Start-->
                <div class="tj-logo">
                    <h1><a href="index.php">City Taxi</a></h1>
                </div>
                <!--Logo End-->
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="tj-nav-holder">
                    ...
                    <div class="book_btn">
                    <?php  if(isset($_SESSION['login'])){ ?><a href="user-account.php">Account <i class="fa fa-user" aria-hidden="true"></i></a><?php }else{ ?> <a href="login.php">Login <i class="fa fa-user" aria-hidden="true"></i></a> <?php } ?>
