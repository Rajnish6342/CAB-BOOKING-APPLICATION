							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="txtimg" required >
								...
								<div class="ml-2 col-sm-6">
									<div id="msg"></div>
										...
										<input type="text" class="form-control" disabled placeholder="Upload File" name="file" id="file">
									...
									<div class="col-lg-12 p-t-20 text-center">
										...
										<button type="submit" name="submit" data-type="success"
