		...
		<div class="tj-wrapper">
			...
			<section class="tj-account-frm">
				<div class="container">
						...
						<div class="col-md-12 col-sm-12">
							<div class="tj-tabs">
								<ul class="nav nav-tabs" role="tablist">
									<li><a href="#user_account" data-toggle="tab"><i class="far fa-user"></i> My Account</a></li>
									...
									<li class=""><a href="#cancel_booking" data-toggle="tab"><i class="fas fa-times"></i> Cancel Booking</a></li>
                    ...
                    $sql = "SELECT vehicle.v_img as Vimage1,bookings.start_loc,bookings.end_loc,bookings.book_ref,bookings.pickup_time,bookings.pickup_date,bookings.bk_status,bookings.price from bookings join vehicle on bookings.v_id=vehicle.v_id  where bookings.email_id='$email'";
